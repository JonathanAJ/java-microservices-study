...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("br.com.jhipster.todolist.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("br.com.jhipster.todolist.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
