package br.com.jardimtech.web.rest;

import static org.assertj.core.api.Assertions.assertThat;

import br.com.jardimtech.IntegrationTest;
import br.com.jardimtech.config.EmbeddedKafka;
import br.com.jardimtech.config.KafkaSseConsumer;
import br.com.jardimtech.config.KafkaSseProducer;
...
@WithMockUser
@EmbeddedKafka
class SpringtodolistKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/springtodolist-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/springtodolist-kafka/consume")
