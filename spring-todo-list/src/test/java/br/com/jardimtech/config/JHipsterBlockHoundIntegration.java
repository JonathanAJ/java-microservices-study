package br.com.jardimtech.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("br.com.jardimtech.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("br.com.jardimtech.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
